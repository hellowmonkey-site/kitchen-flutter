  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () {
          return UserHistoryModel.getUserHistoryList();
        },
        color: Theme.of(context).primaryColor,
        child: userHistoryProvider.historyList.isEmpty
            ? Center(
                child: Text(
                  '暂无数据',
      ...
      child: InkWell(
        ...
        child: Container(
          decoration: BoxDecoration(
              border: itemBorder(
                  isLast: index == userHistoryProvider.historyList.length - 1)),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              final index =
                                  await Application.showBottomSheet(['删除浏览记录']);
                              if (index == 0) {
                                UserHistoryModel.deleteUserHistory(item.id);
                              }
                            },
