...
class SearchPage extends StatelessWidget {
  ...
  FilterChip _chipItem(CategoryItemModel child) {
    return FilterChip(
        avatar: CircleAvatar(
            backgroundColor:
        ...
        selected: searchController.selectedCategory.value.contains(child.name),
        onSelected: (checked) {
          searchController.changeCategory(child.name);
        });
  }
  ...
  Widget _categoryBox() {
    return SingleChildScrollView(
        child: Obx(() => Padding(
              padding:
                  EdgeInsets.only(bottom: searchController.canSearch ? 100 : 0),
              child: Column(
                mainAxisSize: MainAxisSize.max,
                crossAxisAlignment: CrossAxisAlignment.stretch,
  ...
  Widget _searchBtnGroup() {
    return Obx(() => AnimatedPositioned(
        duration: const Duration(milliseconds: 300),
        curve:
            searchController.canSearch ? Curves.bounceInOut : Curves.easeInOut,
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                    ...
                    backgroundColor: Theme.of(Get.context!).bottomAppBarColor,
